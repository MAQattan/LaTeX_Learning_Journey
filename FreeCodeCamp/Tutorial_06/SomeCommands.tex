...
\usepackage{tikz,pgfplots} %(c) for calculator command

\newcommand{\set}[1] {\setlength\itemsep{#1 em}} %(C) For \set{}

%(c) for \calculator symbol
...
\begin{enumerate}
\set{1.2}
\item \calculator\ Let's examine the function.
